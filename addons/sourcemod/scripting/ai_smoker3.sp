...
public void OnPluginStart() {
	...
	g_cvBhopImpulse = CreateConVar("ai_smoker3_bhop_impulse", "100", "连跳加速度", CVAR_FLAGS, true, 0.0);
	...
	g_cvBhopMaxSpeed = CreateConVar("ai_smoker3_bhop_max_speed", "99999", "连跳时的最大速度", CVAR_FLAGS, true, 0.0);
	...
	g_cvBhopMaxDist = CreateConVar("ai_smoker3_bhop_max_dist", "99999", "允许连跳的最大距离, 与目标距离大于这个值时不允许连跳", CVAR_FLAGS, true, 0.0);
	...
	g_cvBhopSideMinAng = CreateConVar("ai_smoker3_bhop_side_minang", "0.0", "连跳时连跳方向最小左右侧偏角度", CVAR_FLAGS, true, 0.0, true, 180.0);
	g_cvBhopSideMaxAng = CreateConVar("ai_smoker3_bhop_side_maxang", "0.0", "连跳时连跳方向最大左右侧偏角度", CVAR_FLAGS, true, 0.0, true, 180.0);
	...
	g_cvBhopNoVisionMaxAng = CreateConVar("_ai_smoker3_bhop_nvis_maxang", "180.0", "无生还者视野时速度向量与视角前向向量在这个角度范围内, 允许连跳", CVAR_FLAGS, true, 0.0);
	...
	g_cvAirVecModifyDegree = CreateConVar("ai_smoker3_airvec_modify_degree", "180.0", "在空中速度方向与自身到目标方向角度超过这个值进行速度修正", CVAR_FLAGS, true, 0.0);
	g_cvAirVecModifyMaxDegree = CreateConVar("ai_smoker3_airvec_modify_degree_max", "0.0", "在空中速度方向与自身到目标方向角度超过这个值不进行速度修正", CVAR_FLAGS, true, 0.0);
