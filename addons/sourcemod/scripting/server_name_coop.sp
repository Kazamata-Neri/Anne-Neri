...
public void OnPluginStart()
{
	...
	g_hAllowDisplayCurrent = CreateConVar("sn_display_current_info", "0", "是否在服名中显示当前路程信息", CVAR_FLAG, true, 0.0, true, 1.0);
	g_hAllowDisplayMode = CreateConVar("sn_display_mode_info", "0", "是否在当前服名中显示是什么模式", CVAR_FLAG, true, 0.0, true, 1.0);
	...
	g_hInfectedLimit = FindConVar("survival_max_specials");
	g_hSpawnInterval = FindConVar("director_special_respawn_interval");
	// AddChangeHook
